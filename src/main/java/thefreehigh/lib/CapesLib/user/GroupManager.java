...
import thefreehigh.lib.CapesLib.cape.CapeManager;
...
public class GroupManager {
    ...
    public Group parse(String name, Map<String, Object> data) {
        ...
        if (!(usersObj instanceof ArrayList) || !(capeUrlObj instanceof String)) {
            CapesLib.logger.error(String.format("Group %s could not be parsed because it either is invalid or missing elements.", name));
            return null;
        }
