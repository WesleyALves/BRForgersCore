package thefreehigh.mods.DragonTech.items.armor;
...
public class ScalesArmor extends ItemArmor implements ISpecialArmor
{
	...
	public ScalesArmor(String unlocalizedName, int armorType)
	{
