...
public class WorldGenDraconyTree extends WorldGenAbstractTree
{
    /**
    ...
    public WorldGenDraconyTree(boolean doBlockNotify)
    {
        super(doBlockNotify);
    }
    ...
    void generateLeafNode(int x, int lenght, int z)
    {
        ...
        for (int i1 = lenght + this.leafDistanceLimit; l < i1; ++l)
        {
            ...
            this.generateLeafs(x, l, z, f, (byte)1, Blocks.leaves);
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.generateLogs(aint, aint1, Blocks.log);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
                this.generateLogs(aint, aint2, Blocks.log);
            }
        }
    }
